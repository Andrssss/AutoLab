...
class BacteriaAnalyzerWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.split_thresh_slider.setMinimum(1)
        self.split_thresh_slider.setMaximum(100)
        self.split_thresh_slider.setValue(40)  # default threshold (% of distance transform max)
    ...
    def update_bac_params(self):
        if self.original_image is not None:
            if self.petri_mask is None:
                ...
                # Draw petri outline again after detection
